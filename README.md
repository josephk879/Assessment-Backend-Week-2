...
**For tasks 1-7, you must write your queries in the `marine_experiments/queries` directory. You can see the expected outputs of these queries in the `marine_experiments/expected_outputs` directory, these may be *more* useful than the tests.**
...
--------------|---------------|------------|-------
 Orca         |             4 | True       |  34.8
 Orca         |             2 | True       |  32.4
 Tiger shark  |             3 | True       |  31.2
 Tiger shark  |             5 | True       |  20.4
